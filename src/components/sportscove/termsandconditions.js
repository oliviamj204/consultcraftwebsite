  ...
  return (
    <div className="tc-container">
      ...
      <div className="tc-content">
        <p>
          <strong>1. OWNERSHIP OF SITE AND APP; AGREEMENT TO TERMS OF USE</strong> These Terms and Conditions of Use (the “Terms of Use”, "Agreement") apply to all ConsultCraft LLC web sites, including without limitation, those located at www.consultcraftinc.com and www.consultcove.com, and all associated sites linked to www.consultcraftinc.com by ConsultCraft LLC, its parent and subsidiaries, affiliates and related entities (the “Site”). The Site is the property of ConsultCraft LLC. BY USING THE SITE, YOU AGREE TO THESE TERMS OF USE; IF YOU DO NOT AGREE, DO NOT USE THE SITE.
        </p>
        ...
        <p><strong>3. SUBSCRIPTION FEES, PAYMENT TERMS AND REFUND POLICY</strong></p>
        ...
        <p><strong>5. ACCESS AND USAGE OF YOUR IMAGES</strong></p>
        ...
        <p><strong>6. CONFIDENTIAL INFORMATION</strong></p>
        ...
        <p><strong>7. FRAUD AND IMPROPER CONDUCT</strong></p>
        ...
        <p><strong>8. KEY POINTS TO BE BORNE IN MIND IN RELATION TO THE SERVICES OFFERED THROUGH THE PLATFORM</strong></p>
        ...
        <p><strong>9. LIMITATIONS AND DISCLAIMER OF WARRANTY</strong></p>
        ...
        <p><strong>17. GRIEVANCE OFFICER</strong></p>
