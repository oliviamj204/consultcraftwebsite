...
const ScPrivacyPolicy = () => {
  ...
  return (
    <div className="tc-container">
      <div className="tc-updated">SportsCove Privacy Policy</div>
      ...
      <div className="tc-content">
        ...
        <p><strong>2.2 Sensitive Personal Information:</strong> Includes Date of Birth, financial account information such as bank account for payouts and credit cards for online session payments, precise geolocation data designated as sensitive under state privacy laws.</p>
        ...
        <p><u><strong>3.1 Information You Provide Directly:</strong></u></p>
        <ul>
          <li><strong>Account Information:</strong> Full Name, email, phone number, DOB, username, password, profile photo, linked social accounts (optional), media for profile (optional if not service provider).</li>
          <li><strong>Profile Information:</strong> Sports interests, tasks, availability, experience level, and location (city/country).</li>
        ...
        <p><u><strong>3.2 Information Collected Automatically:</strong></u></p>
        <ul>
        ...
        <p><u><strong>3.3 Information from Third Parties:</strong></u></p>
        <ul>
        ...
        <p><u>How to Exercise:</u> Contact us at sc-support@consultcraftinc.com for any issues. For any escalations please use info@consultcraftinc.com to reach out to us.</p>
        ...
        <ul>
          ...
          <li><strong>Transactions:</strong> 5 years (tax/accounting).</li>
        ...
        <ul>
          <li>Email: info@consultcraftinc.com</li>
          <li>Mailing Address: ConsultCraft Inc., 4520 W Oakeller Avenue, Suite #13348 Tampa, FL 33611</li>
        </ul>

        <p><strong>15. GOVERNING LAW</strong></p>
        <p>This Privacy Policy shall be governed by and construed under the laws of the United States and the State of Florida, without regard to conflict of law principles. Users agree that disputes relating to privacy or data protection will be resolved under applicable U.S. and state laws.</p>
